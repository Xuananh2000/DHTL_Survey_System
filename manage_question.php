				...
				<div class="row">
					<div class="col-sm-6 border-right">
							...
							<div class="form-group">
								...
								<textarea name="question" id="" cols="30" rows="4" class="form-control" required><?php echo isset($question)? $question: '' ?></textarea>
							</div>
							<div class="form-group">
					...
					<div class="col-sm-6">
						...
						<div class="preview">
							<?php if(!isset($id)): ?>
								<textarea name="frm_opt" id="" cols="30" rows="10" class="form-control" disabled="" placeholder="User'll write something here..."></textarea>
							<?php else: ?>
										...
										<tr class="">
											<td class="text-center">
												<div class="icheck-primary d-inline" data-count = '<?php echo $i ?>'>
													<input type="<?php echo $opt ?>" id="<?php echo $opt ?>Primary<?php echo $i ?>" name="<?php echo $opt ?>" checked="" required>
